...
Language barriers cause confusion, panic, and poor health decisions
No personalized guidance based on actual clinical history

Doctors:
High administrative burden due to manual data entry
...
1.Reads and understands medical records
2.Translates clinical jargon into local languages
...
Voice-to-Text: AWS HealthScribe
Document OCR: AWS Textract
Backend: AWS Lambda (Serverless)
Database: Amazon DynamoDB
Frontend: React Native
Health APIs: ABDM (ABHA) Sandbox APIs
